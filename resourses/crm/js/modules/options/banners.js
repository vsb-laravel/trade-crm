    ...
    index($c,d,x){
        ...
        $tr.append(`<td>
            <div class="ui basic buttons">
                <button class="ui red icon button" data-action="/banner/${banner.id}" data-method="DELETE" data-callback="crm.banners.touch" data-autostart="true" onclick="skymechanics.submiterHandler(this)">
