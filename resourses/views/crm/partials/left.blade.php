...
@ifmodule('customers')
    ...
    <div class="ui simple dropdown item">
        ...
        <a data-href="page__customers_clients" onclick="page.show(this,'customers','clients');" >{{ trans('crm.dashboard.customers') }}<i class="dropdown icon"></i></a>
        <div class="ui menu">
            @can('marketing')
...
@ifmodule('finance')
    ...
    <div class="ui simple dropdown item">
        ...
        <a href="javascript:0;" data-href="page__finance_dashboard" onclick="page.show(this,'finance','dashboard');">{{ trans('crm.finance.title') }}<i class="dropdown icon"></i></a>
        <div class="menu">
            @can('admin')
...
<div class="ui simple dropdown item">
    ...
    <a onclick="page.show(this,'pairs','list');">{{ trans('crm.dashboard.instruments') }}<i class="dropdown icon"></i></a>
    <div class="menu">
