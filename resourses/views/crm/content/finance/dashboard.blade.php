<div class="right ui rail">
    <div class="ui menu vertical byperiod sticky" data-context="#page__finance_dashboard">
        <a class="ui item" onclick="crm.finance.byperiod(this,'today')">{{ trans('crm.periods.today') }}</a>
        <a class="ui item active" onclick="crm.finance.byperiod(this,'7d')">{{ trans('crm.periods.last_7_days') }}</a>
        <a class="ui item" onclick="crm.finance.byperiod(this,'m')">{{ trans('crm.periods.this_month') }}</a>
