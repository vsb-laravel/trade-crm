...
export class Container{
    constructor(){
        ...
        this.$container.sidebar({
            ...
            onShow: ()=>{ console.debug((new Date()).toString(),'sidebar showed'); this.slided = true;},
    ...
    after(){
        ...
        this.$menu.find('.item').addClass('remove');
    ...
    show(uid){
        this.cards[uid].render().then( (that) => {
            ...
            this.$menu.find(`.item[data-uid="${uid}"]`).addClass('active');
