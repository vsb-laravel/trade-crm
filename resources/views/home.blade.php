...
<div class="ui main container">
    ...
    <div class="ui segment page__" id="page__customers">
        <div class="ui  menu">
            <div class="ui right secondary menu" data-context="#page__customers">
                @can('marketing')
                ...
                @can('export')
                <div class="item">
                    <form class="ui " action="/export/customers">
                        {{-- <div class="field"> --}}
                            <button type="submit" class="ui icon olive button">
    ...
    <div class="ui segment page__" id="page__pairs">
        <div class="ui menu">
            <div class="ui right secondary menu" data-context="#page__pairs">
    ...
    <div class="ui segment page__" id="page__finance">
        <div class="ui menu">
            <div class="ui right secondary menu" data-context="#page__finance">
    ...
    <div class="ui segment page__" id="page__options">
        <div class="ui menu">
            <div class="ui right secondary menu" data-context="#page__options">
                @can('chief')
