            ...
            <div class="ui items">
                <div class="ui item">
                    <div class="ui tiny image centered middle aligned">
                        <!-- <img src="/vendor/crm/images/avatar/1.jpg"> -->
...
<div class="ui fixed inverted menu" id="topMenu">
...
<div class="ui inverted left push sidebar vertical labeled stackable big menu" id="menuBar">
    @include('crm.partials.left')
</div>
@push('scripts')
    <script>
    $('.container.main').visibility({
        onTopVisible: function(calculations) {
            console.log('#topMenu onTopVisible');
            $('#topMenu').addClass('inverted')
        },
        onTopPassed: function(calculations) {
            console.log('#topMenu onTopPassed');
            // $('#topMenu').removeClass('inverted')
        },
        onUpdate: function(calculations) {
            // console.log('#topMenu onUpdate');
        }
    });
    </script>
@endpush
