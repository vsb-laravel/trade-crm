...
<table class="ui attached table selectable" id="users">
    ...
    <tbody id="user_list" data-name="user-list" class="loadering priorited" data-action="/json/user?_simple=true&rights_id[0]=1&rights_id[1]=3" data-function="crm.user.list" data-autostart="true" data-need-loader="true" data-trigger=""></tbody>
</table>
