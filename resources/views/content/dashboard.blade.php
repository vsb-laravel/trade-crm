...
<div class="ui stackable menu">
    <div class="ui borderless right menu byperiod bound" data-context="#page__dashboard">
        ...
        <a class="ui item" onclick="page.dashboard.byperiod(this,'7d')">{{ trans('crm.periods.last_7_days') }}</a>
        <a class="ui item active" onclick="page.dashboard.byperiod(this,'m')">{{ trans('crm.periods.this_month') }}</a>
        ...
        <div class="six wide column">
            <div class="ui segment aligned left">
                ...
                <div class="meta" style="margin-top:1em;">
                    <span class="date">{{ trans('crm.dashboard.for_this_month') }}</span>
                </div>
            </div>
        </div>
        <div class="six wide column">
