...
import { Banners } from './modules/options/banners';
import { SystemEvent } from './core/system';
...
socket.on('event', function (e) {
    ...
    // console.debug('new event in socket',e);
...
socket.on('user', function (e) {
    ...
    if(cardContainer.cards[`cuser_${e.data.id}`]) {
        // console.debug('new userstate',e.data);
