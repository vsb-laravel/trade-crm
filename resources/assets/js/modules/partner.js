export class Partner {
    ...
    list($c, d) {
        ...
        d.data.map( (row,i) => {
            ...
            const newCanFollow = {...canFollow,can:!canFollow.can};
            ...
            tr.append(`<td>
                <div class="ui slider checkbox submiter" data-action="/json/user/meta?meta_name=can_follow" data-name="user-can-follow">
                    ...
                    <input type="hidden" data-name="meta_value" value='${JSON.stringify(newCanFollow)}'}/>
                    <input class="submit" data-trigger="change" type="checkbox" ${canFollow.can?'checked="checked"':''}/>
